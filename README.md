...
| hero `.btn.todo` ×3 | paper, arXiv and code URLs — drop the `todo` class once linked. The manuscript PDF is deliberately **not** published here while the paper is under review |
...
```sh
pdftocairo -png -r 200 -singlefile ../pics/main_figure/skatenav_teaser.pdf assets/img/teaser
ffmpeg -i assets/img/teaser.png -q:v 3 assets/img/teaser.jpg && rm assets/img/teaser.png
```
